...
\+: adds a course to the array that the student has input 
...
\begin{DoxyParams}{Parameters}
{\em outs} & the ostream to display evrything through \\
\hline
\end{DoxyParams}
\begin{DoxySeeAlso}{See also}
get\+\_\+course\+\_\+number() 
...
removes the course object with the same name as the given parameter 


\begin{DoxyParams}{Parameters}
{\em coursename} & the course you want to remove \\
\hline
\end{DoxyParams}
\begin{DoxySeeAlso}{See also}
get\+\_\+course\+\_\+number() 
